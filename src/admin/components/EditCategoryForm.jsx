...
export default function EditCategoryForm({ category, onSubmit, onCancel, error }) {
  const [formData, setFormData] = useState({
    name: category.name,
    description: category.description,
    processingTime: category.processingTime.toString(),
  ...
  const validateForm = () => {
    ...
    if (!formData.processingTime.trim()) {
      ...
      const parsedTime = parseFloat(formData.processingTime)
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      onSubmit({
        ...
        processingTime: formData.processingTime.toString(), // Ensure string
