// This file contains all the icon components used in the admin panel
// These are simplified SVG icons similar to those from Lucide React
...
export function ShoppingBasket({ className }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function BarChart3({ className }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function Package({ className }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function Shirt({ className }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function MoreHorizontal({ className }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function HelpCircle({ className }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function ToggleLeft({ className }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function ToggleRight({ className }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
